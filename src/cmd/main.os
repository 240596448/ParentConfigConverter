...
Процедура ВыполнитьПриложение()
	...
	Приложение.ДобавитьКоманду("i info", "Вывод информации по поддержке", Новый КомандаИнформация);
	Приложение.ДобавитьКоманду("m merge", "Слияние файлов настроек", Новый КомандаСлияниеНастроек);
