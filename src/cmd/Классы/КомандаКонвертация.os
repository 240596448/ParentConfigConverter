...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("dump-cache", "", "Сохранять пары Name-Id, полученные из дампа, в отдельный файл (например, src/ConfigID.xml)")
				.ТСтрока();
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Если ЗначениеЗаполнено(ПутьКФайлуКэшаИдентификаторов) Тогда
		Метаданные.СоздатьКэш(ПутьКФайлуКэшаИдентификаторов);
	КонецЕсли;
